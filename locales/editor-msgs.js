...
export default {
  "en": {
    ...
    "gui.betaModal.title": "Information",
    "gui.betaModal.body": "This application is in beta.",
    "gui.betaModal.close": "Close",
  ...
  "es": {
    "gui.alerts.lostPeripheralConnection": "OpenBlock perdió la conexión con {extensionName}.",
    "gui.alerts.tryAgain": "Intentar de nuevo",
    "gui.alerts.download": "Descargar",
    "gui.connection.reconnect": "Reconectar",
    "gui.alerts.uploadFirmware": "Subir firmware",
    "gui.backpack.costumeLabel": "disfraz",
    "gui.backpack.soundLabel": "sonido",
    "gui.backpack.scriptLabel": "guion",
    "gui.backpack.spriteLabel": "personaje",
    ...
    "gui.unsupportedBrowser.label": "Navegador no compatible",
    "gui.unsupportedBrowser.errorLabel": "Ocurrió un error",
    "gui.unsupportedBrowser.notRecommended": "Lo sentimos mucho, parece que estás usando una versión del navegador que OpenBlock no soporta. Recomendamos actualizar a la versión más reciente de un navegador compatible, como Google Chrome, Mozilla Firefox, Microsoft Edge o Apple Safari.",
    "gui.unsupportedBrowser.description": "Lo sentimos mucho, pero OpenBlock no soporta este navegador. Recomendamos actualizar a la versión más reciente de un navegador compatible, como Google Chrome, Mozilla Firefox, Microsoft Edge o Apple Safari.",
    "gui.unsupportedBrowser.back": "Volver",
    "gui.unsupportedBrowser.previewfaq": "Para saber más, visita el {previewFaqLink}.",
    "gui.unsupportedBrowser.previewfaqlinktext": "FAQ",
    "gui.cards.all-tutorials": "Tutoriales",
    "gui.cards.shrink": "Reducir",
    ...
    "gui.connection.auto-scanning.noPeripheralsFound": "No se encontraron dispositivos",
    "gui.connection.auto-scanning.prescan": "Ten tu dispositivo cerca, luego comienza a buscar.",
    "gui.connection.auto-scanning.pressbutton": "Presiona el botón en tu dispositivo.",
    "gui.connection.auto-scanning.start-search": "Comenzar búsqueda",
    ...
    "gui.connection.accessDeniedError.errorMessage": "Vaya, acceso a serialport denegado, por favor verifica si el puerto serie está ocupado.",
    "gui.connection.unknownErrorCode31.errorMessage": "Vaya, código de error desconocido 31, se recomienda volver a enchufar el dispositivo.",
    "gui.connection.error.errorMessage": "Vaya, parece que algo salió mal.",
    ...
    "gui.connection.scanning.listAll": "Mostrar todos los dispositivos conectables",
    "gui.connection.scanning.lookingforperipherals": "Buscando dispositivos",
    "gui.connection.scanning.noPeripheralsFound": "No se encontraron dispositivos",
    "gui.connection.scanning.instructions": "Selecciona tu dispositivo en la lista de arriba.",
    "gui.connection.search": "Actualizar",
    "gui.connection.unavailable.installscratchlink": "Asegúrate de que OpenBlock Link esté instalado y en funcionamiento",
    "gui.connection.unavailable.connectUsbEnableBluetooth": "Verifica que el cable USB esté conectado o que el Bluetooth esté habilitado",
    ...
    "gui.crashMessage.label": "¡Vaya! Algo salió mal.",
    "gui.crashMessage.description": "Lo sentimos mucho, pero parece que OpenBlock se ha bloqueado. Este error ha sido reportado automáticamente al equipo de OpenBlock. Por favor, actualiza tu página para intentarlo de nuevo.",
    "gui.crashMessage.errorNumber": "Tu error fue registrado con el id {errorId}",
    "gui.crashMessage.reload": "Recargar",
    "gui.customProcedures.myblockModalTitle": "Crear un Bloque",
    "gui.customProcedures.addAnInputNumber": "Agregar una entrada",
    "gui.customProcedures.numberType": "número",
    "gui.customProcedures.addAnInputText": "Agregar una entrada",
    ...
    "gui.customProcedures.runWithoutScreenRefresh": "Ejecutar sin refrescar la pantalla",
    "gui.customProcedures.cancel": "Cancelar",
    "gui.customProcedures.ok": "Aceptar",
    "gui.deviceTypeModal.deviceTypeTitle": "Elige un tipo de programación",
    "gui.deviceTypeModal.arduino": "Arduino",
    "gui.deviceTypeModal.python": "Python",
    "gui.deviceTypeModal.microPython": "MicroPython",
    "gui.deviceTypeModal.cancel": "Cancelar",
    "gui.SpriteInfo.direction": "Dirección",
    "gui.directionPicker.rotationStyles.allAround": "Todo alrededor",
    "gui.directionPicker.rotationStyles.leftRight": "Izquierda/Derecha",
    "gui.directionPicker.rotationStyles.dontRotate": "No girar",
    "gui.gui.addExtension": "Agregar Extensión",
    "gui.gui.blockTab": "Bloques",
    "gui.gui.backdropsTab": "Fondos",
    "gui.gui.costumesTab": "Disfraces",
    "gui.gui.soundsTab": "Sonidos",
    "gui.hardwareConsole.send": "Enviar",
    "gui.hardwareConsole.buadrate": "Baudios",
    "gui.hardwareConsole.endOfLine": "Fin de línea",
    "gui.hardwareConsole.hexform": "Forma Hex",
    "gui.hardwareConsole.autoScroll": "Desplazamiento automático",
    "gui.hardwareHeader.upload": "Subir",
    "gui.stageHeader.codeStageSizeLarge": "Cambiar a escenario grande",
    "gui.stageHeader.codeStageSizeSmall": "Cambiar a escenario pequeño",
    "gui.stageHeader.hideStage": "Ocultar escenario",
    ...
    "gui.extensionLibrary.version": "Versión",
    "gui.extensionLibrary.author": "Autor",
    "gui.extensionLibrary.programMode": "Modo de programación",
    "gui.extensionLibrary.programLanguage": "Lenguaje de programación",
    "gui.extensionLibrary.deviceLearnMore": "Aprender más",
    "gui.extensionLibrary.extensionHelp": "Ayuda",
    "gui.extensionLibrary.Processing": "Procesando...",
    "gui.extensionLibrary.loaded": "Cargado",
    "gui.extensionLibrary.notLoaded": "No cargado",
    "gui.library.filterPlaceholder": "Buscar",
    "gui.library.allTag": "Todo",
    "gui.loader.message1": "Creando bloques...",
    "gui.loader.message2": "Cargando personajes...",
    ...
    "gui.loader.creating": "Creando Proyecto",
    ...
    "gui.accountMenu.accountSettings": "Configuración de cuenta",
    ...
    "gui.menuBar.community": "Abrir comunidad",
    "gui.menuBar.wiki": "Wiki",
    "gui.menuBar.restoreSprite": "Restaurar personaje",
    ...
    "gui.menuBar.checkUpdate": "Buscar actualización",
    "gui.menuBar.installDriver": "Instalar controlador",
    "gui.menuBar.clearCacheAndRestart": "Limpiar caché y reiniciar",
    "gui.menuBar.file": "Archivo",
    "gui.menuBar.downloadToComputer": "Guardar en tu computadora",
    "gui.menuBar.edit": "Editar",
    "gui.menuBar.turboModeOff": "Desactivar Modo Turbo",
    "gui.menuBar.turboModeOn": "Activar Modo Turbo",
    "gui.menuBar.noDeviceSelected": "Ningún dispositivo seleccionado",
    "gui.menuBar.noConnection": "Desconectado",
    "gui.menuBar.uploadFirmware": "Subir Firmware",
    "gui.menu-bar.programMode": "Modo de programación",
    "gui.gui.projectTitlePlaceholder": "Título del proyecto aquí",
    "gui.menuBar.saveNowLink": "Guardar ahora",
    "gui.menuBar.isShared": "Compartido",
    ...
    "gui.monitor.contextMenu.default": "lectura normal",
    "gui.monitor.contextMenu.large": "lectura grande",
    ...
    "gui.gui.variableScopeOptionAllSprites": "Para todos los personajes",
    "gui.gui.variableScopeOptionSpriteOnly": "Solo para este personaje",
    "gui.gui.cloudVariableOption": "Variable en la nube (almacenada en el servidor)",
    "gui.gui.variablePromptAllSpritesMessage": "Esta variable estará disponible para todos los personajes.",
    "gui.gui.listPromptAllSpritesMessage": "Esta lista estará disponible para todos los personajes.",
    ...
    "gui.recordingStep.beginRecord": "Comienza a grabar haciendo clic en el botón de abajo",
    "gui.recordingStep.permission": "{arrow}Necesitamos tu permiso para usar tu micrófono",
    "gui.recordingStep.stop": "Detener grabación",
    ...
    "gui.soundEditor.copyToNew": "Copiar a nuevo",
    ...
    "gui.SpriteInfo.sprite": "Personaje",
    ...
    "gui.spriteSelector.addSpriteFromLibrary": "Elegir un personaje",
    "gui.spriteSelector.addSpriteFromPaint": "Pintar",
    "gui.spriteSelector.addSpriteFromSurprise": "Sorpresa",
    "gui.spriteSelector.addSpriteFromFile": "Subir personaje",
    "gui.stageHeader.stageSizeLarge": "Cambiar a escenario grande",
    "gui.stageHeader.stageSizeSmall": "Cambiar a escenario pequeño",
    "gui.stageHeader.stageSizeFull": "Entrar en modo pantalla completa",
    "gui.stageHeader.stageSizeUnFull": "Salir del modo pantalla completa",
    "gui.stageHeader.fullscreenControl": "Control de pantalla completa",
    "gui.spriteSelector.addBackdropFromLibrary": "Elegir un fondo",
    ...
    "gui.telemetryOptIn.label": "Enviar estadísticas para mejorar OpenBlock",
    "gui.telemetryOptIn.body1": "El equipo de OpenBlock siempre busca entender mejor cómo se usa OpenBlock en todo el mundo. Para ayudar en este esfuerzo, puedes permitir que OpenBlock envíe automáticamente información de uso al equipo de OpenBlock.",
    "gui.telemetryOptIn.body2": "La información que recopilamos incluye selección de idioma, uso de bloques y algunos eventos como guardar, cargar y subir un proyecto. NO recopilamos ninguna información personal. Consulta nuestra {privacyPolicyLink} para más información.",
    "gui.telemetryOptIn.privacyPolicyLink": "Política de privacidad",
    "gui.telemetryOptIn.optInText": "Compartir mis datos de uso con el equipo de OpenBlock",
    "gui.telemetryOptIn.optInTooltip": "Habilitar telemetría",
    "gui.telemetryOptIn.optOutText": "No compartir mis datos de uso con el equipo de OpenBlock",
    "gui.telemetryOptIn.optOutTooltip": "Deshabilitar telemetría",
    "gui.telemetryOptIn.settingWasUpdated": "Tu configuración ha sido actualizada.",
    "gui.telemetryOptIn.buttonClose": "Cerrar",
    "gui.turboMode.active": "Modo Turbo",
    "gui.updateModal.close": "Cerrar",
    "gui.updateModal.downloading": "Descargando",
    "gui.updateModal.abort": "Abortar",
    "gui.updateModel.tileCheckingForUpdate": "Buscando actualización",
    "gui.updateModel.checkingTips": "Dependiendo de tu red, este paso puede tardar unos segundos o varios segundos, por favor espera.",
    "gui.updateModel.tileUpdateExternalResource": "Nueva versión de recurso externo detectada",
    "gui.updateModel.tileUpdateApplication": "Nueva versión de esta aplicación detectada",
    "gui.updateModal.updateLater": "Actualizar más tarde",
    "gui.updateModal.updateAndRestart": "Actualizar y reiniciar",
    "gui.updateModel.tileAlreadyLatest": "No se detectó una nueva versión",
    "gui.updateModel.alreadyLatestTips": "OpenBlock ya está en la versión más reciente.",
    "gui.updateModel.tileError": "La operación falló",
    "gui.updateModel.upgradingExternalResource": "Actualizando recurso externo",
    "gui.updateModal.deletingCompressedFile": "Eliminando archivo comprimido",
    "gui.updateModal.deletingCacheFile": "Eliminando archivo de caché",
    "gui.updateModal.extractingCompressedFile": "Extrayendo archivo comprimido",
    "gui.updateModal.verifyingCompressedFile": "Verificando archivo comprimido",
    "gui.updateModal.verifyingCacheFile": "Verificando archivo de caché",
    "gui.updateModel.tileResourceUpdateFinish": "Actualización de recurso externo completada",
    "gui.updateModal.resourceUpdateFinishTips": "Actualización de recurso externo completada, la aplicación se reiniciará automáticamente en 3 segundos.",
    "gui.updateModel.downloadingApplication": "Descargando aplicación",
    "gui.updateModel.tileApplicationDownloadFinish": "Descarga de la aplicación completada",
    "gui.updateModal.applicationDownloadeFinishTips": "Descarga de la aplicación completada, se cerrará automáticamente y comenzará el instalador en 3 segundos.",
    "gui.betaModal.title": "Información",
    "gui.betaModal.body": "Esta aplicación está en beta.",
    "gui.betaModal.close": "Cerrar",
    "gui.uploadProgress.uploading": "Subiendo",
    "gui.uploadProgress.uploadSuccess": "Subida exitosa",
    "gui.uploadProgress.uploadError": "Error de subida",
    "gui.uploadProgress.uploadTimeout": "Tiempo de espera agotado en la subida",
    "gui.uploadProgress.uploadAborted": "Subida abortada",
    "gui.uploadProgress.abort": "Abortar",
    "gui.uploadProgress.close": "Cerrar",
    "gui.webglModal.label": "Tu navegador no soporta WebGL",
    "gui.webglModal.description": "Desafortunadamente parece que tu navegador o computadora {webGlLink}. Esta tecnología es necesaria para que OpenBlock funcione.",
    "gui.webglModal.webgllink": "no soporta WebGL",
    "gui.webglModal.back": "Volver",
    "gui.webglModal.previewfaq": "Para saber más, visita el {previewFaqLink}.",
    "gui.webglModal.previewfaqlinktext": "FAQ",
    "gui.costumeLibrary.chooseABackdrop": "Elegir un fondo",
    "gui.costumeLibrary.chooseACostume": "Elegir un disfraz",
    "gui.costumeTab.addBackdropFromLibrary": "Elegir un fondo",
    "gui.costumeTab.addCostumeFromLibrary": "Elegir un disfraz",
    ...
    "gui.deviceLibrary.chooseADevice": "Elegir un dispositivo",
    "gui.deviceLibrary.deviceUrl": "Introducir la URL del dispositivo",
    "gui.deviceLibrary.arduinoTag": "Arduino",
    "gui.deviceLibrary.microPythonTag": "MicroPython",
    "gui.deviceLibrary.kitTag": "Kit",
    "gui.extensionLibrary.chooseAnExtension": "Elegir una extensión",
    "gui.extensionLibrary.extensionUrl": "Introducir la URL de la extensión",
    "gui.library.shieldTag": "Escudo",
    "gui.library.actuatorTag": "Actuador",
    "gui.library.sensorTag": "Sensor",
    "gui.library.displayTag": "Pantalla",
    "gui.library.communicationTag": "Comunicación",
    "gui.library.otherTag": "Otro",
    "gui.hardwareConsole.noLineTerminators": "Sin terminadores de línea",
    "gui.hardwareConsole.lineFeed": "Salto de línea",
    "gui.hardwareConsole.carriageReturn": "Retorno de carro",
    "gui.hardwareConsole.lfAndCr": "LF & CR",
    "gui.monitors.importListColumnPrompt": "¿Qué columna debería usarse (1-{numberOfColumns})?",
    "gui.recordingStep.alertMsg": "No se pudo iniciar la grabación",
    "gui.soundLibrary.chooseASound": "Elegir un sonido",
    "gui.soundTab.fileUploadSound": "Subir sonido",
    "gui.soundTab.surpriseSound": "Sorpresa",
    "gui.soundTab.recordSound": "Grabar",
    "gui.soundTab.addSoundFromLibrary": "Elegir un sonido",
    "gui.spriteLibrary.chooseASprite": "Elegir un personaje",
    "gui.tipsLibrary.tutorials": "Elegir un tutorial",
    "gui.updateModal.updateWarning": "Los proyectos no guardados se perderán, ¿continuar con la actualización y reiniciar?",
    "gui.uploadProgress.uploadErrorMessage": "Error de subida",
    "gui.uploadProgress.uploadTimeoutMessage": "Tiempo de espera agotado en la subida",
    "gui.alerts.createsuccess": "Nuevo proyecto creado.",
    "gui.alerts.createcopysuccess": "Proyecto guardado como una copia.",
    "gui.alerts.createremixsuccess": "Proyecto guardado como un remix.",
    "gui.alerts.creating": "Creando nuevo...",
    "gui.alerts.creatingCopy": "Copiando proyecto...",
    "gui.alerts.creatingRemix": "Remixeando proyecto...",
    "gui.alerts.creatingError": "No se pudo crear el proyecto. ¡Por favor, inténtalo de nuevo!",
    "gui.alerts.savingError": "No se pudo guardar el proyecto.",
    "gui.alerts.savesuccess": "Proyecto guardado.",
    "gui.alerts.saving": "Guardando proyecto...",
    "gui.alerts.cloudInfo": "Ten en cuenta que las variables en la nube solo admiten números, no letras o símbolos. {learnMoreLink}",
    "gui.alerts.cloudInfoLearnMore": "Aprende más.",
    "gui.alerts.importing": "Importando...",
    "gui.alerts.workspaceIsEmpty": "El espacio de trabajo está vacío",
    "gui.alerts.workspaceIsNotEmpty": "El espacio de trabajo no está vacío, por favor límpialo primero",
    "gui.alerts.uploadError": "Error de subida",
    "gui.alerts.uploadSuccess": "Subida exitosa",
    "gui.alerts.selectADeviceFirst": "Por favor, selecciona un dispositivo primero",
    "gui.alerts.connectAPeripheralFirst": "Por favor, conecta un periférico primero",
    "gui.alerts.codeEditorIsLocked": "El editor de código está bloqueado, si deseas editar el código, por favor haz clic en el botón de desbloqueo primero",
    "gui.alerts.codeEditorIsUnlocked": "El editor de código está desbloqueado, si deseas generar código a partir de bloques, por favor haz clic en el botón de bloqueo primero",
    "gui.defaultProject.chirp": "Chirrido",
    "gui.defaultProject.variable": "mi variable",
    "gui.howtos.intro-move-sayhello-hat.name": "Empezando",
    "gui.howtos.intro-move.step_stepMove": "Añadir un bloque de movimiento",
    "gui.howtos.add-a-move-block.step_stepSay": "Añadir un bloque de decir",
    ...
    "gui.howtos.animate-a-name.step_AnimatePickLetter": "Elegir un personaje de letra",
    "gui.howtos.animate-a-name.step_AnimatePlaySound": "Reproducir un sonido al hacer clic",
    "gui.howtos.animate-a-name.step_AnimatePickLetter2": "Elegir otro personaje de letra",
    "gui.howtos.animate-a-name.step_AnimateChangeColor": "Cambiar color",
    "gui.howtos.animate-a-name.step_AnimateSpin": "Elegir otro personaje de letra y hacerlo girar",
    "gui.howtos.animate-a-name.step_AnimateGrow": "Elegir otro personaje de letra y hacerlo crecer",
    ...
    "gui.howtos.imagine.step_imagineChooseBackdrop": "Elige cualquier fondo",
    "gui.howtos.imagine.step_imagineChooseSprite": "Elige cualquier personaje",
    "gui.howtos.imagine.step_imagineFlyAround": "Presiona la barra espaciadora para deslizarte",
    "gui.howtos.imagine.step_imagineChooseAnotherSprite": "Elige otro personaje",
    "gui.howtos.imagine.step_imagineLeftRight": "Mover izquierda-derecha",
    "gui.howtos.imagine.step_imagineUpDown": "Mover arriba-abajo",
    "gui.howtos.imagine.step_imagineChangeCostumes": "Cambiar disfraces",
    "gui.howtos.imagine.step_imagineGlideToPoint": "Deslizarse hacia un punto",
    "gui.howtos.imagine.step_imagineGrowShrink": "Agrandar y encoger",
    "gui.howtos.imagine.step_imagineChooseAnotherBackdrop": "Elige otro fondo",
    "gui.howtos.imagine.step_imagineSwitchBackdrops": "Cambiar fondos",
    "gui.howtos.imagine.step_imagineRecordASound": "Añadir un sonido",
    "gui.howtos.imagine.step_imagineChooseSound": "Elige tu sonido",
    "gui.howtos.make-music.name": "Hacer música",
    "gui.howtos.Make-Music.step_PickInstrument": "Elige un personaje de instrumento",
    "gui.howtos.Make-Music.step_PlaySoundClick": "Reproducir sonido al hacer clic",
    "gui.howtos.Make-Music.step_MakeSong": "Crear una canción",
    "gui.howtos.make-music.step_MakeBeat": "Elige un tambor y crea un ritmo",
    "gui.howtos.make-music.step_MakeBeatBox": "Elige el personaje de micrófono y crea un beatbox sorpresa",
    "gui.howtos.story.name": "Crear una historia",
    "gui.howtos.story.step_addbg": "Añadir un fondo",
    "gui.howtos.story.step_addsprite": "Añadir un personaje",
    "gui.howtos.story.step_saysomething": "Decir algo",
    "gui.howtos.story.step_addanothersprite": "Añadir otro personaje",
    "gui.howtos.story.step_flip": "Voltear dirección",
    "gui.howtos.story.step_conversation": "Tener una conversación",
    "gui.howtos.story.addanotherbg": "Añadir otro fondo",
    "gui.howtos.story.step_swithbg": "Cambiar fondos",
    "gui.howtos.story.step_hidewizard": "Ocultar un personaje",
    "gui.howtos.story.step_showwizard": "Mostrar un personaje",
    "gui.howtos.make-a-chase-game.name": "Hacer un juego de persecución",
    "gui.howtos.Chase-Game.step_BG": "Añadir un fondo",
    "gui.howtos.chase-game.step_AddOcto": "Añadir un personaje",
    "gui.howtos.make-music.step_LeftRight": "Mover derecha e izquierda con las flechas",
    "gui.howtos.Chase-Game.step_UpDown": "Mover arriba y abajo con las flechas",
    "gui.howtos.Chase-Game.step_AddStar": "Añadir otro personaje",
    "gui.howtos.Chase-Game.step_MoveRandom": "Moverse aleatoriamente",
    "gui.howtos.Chase-Game.step_WhenTouch": "En el personaje de pulpo, al tocar reproducir sonido",
    "gui.howtos.Chase-Game.step_ScoreVariable": "Crear una variable de puntuación",
    "gui.howtos.Chase-Game.ScoreWhenTouch": "En el personaje del pulpo, al tocar añade puntuación",
    "gui.howtos.animate-char.name": "Animar un personaje",
    "gui.howtos.animate-char.step_addbg": "Añadir un fondo",
    "gui.howtos.animate-char.step_addsprite": "Añadir un personaje",
    "gui.howtos.animate-char.step_saysomething": "Decir algo",
    "gui.howtos.animate-char.step_addsound": "Añadir sonido",
    "gui.howtos.animate-char.step_animatetalking": "Animar el habla",
    "gui.howtos.animate-char.step_arrowkeys": "Mover usando las teclas de flecha",
    ...
    "gui.howtos.Make-A-Game.step_GamePickSprite": "Elegir un personaje",
    "gui.howtos.make-a-game.step_GamePlaySound": "Reproducir sonido al hacer clic",
    "gui.howtos.make-a-game.step_GameAddScore": "Crear una variable de puntuación",
    "gui.howtos.make-a-game.step_GameChangeScore": "Al hacer clic, aumentar la puntuación",
    "gui.howtos.make-a-game.step_Random": "Ir a una posición aleatoria",
    "gui.howtos.make-music.step_GameChangeColor": "Cambiar color",
    "gui.howtos.make-music.step_ResetScore": "Reiniciar puntuación",
    "gui.howtos.make-it-fly.name": "Haz que vuele",
    ...
    "gui.howtos.fly.step_stepflySaySomething": "Decir algo",
    "gui.howtos.add-a-move-block.step_stepflyMoveArrows": "Mover con las teclas de flecha",
    "gui.howtos.fly.step_stepflyChooseObject": "Elige un objeto para recolectar",
    "gui.howtos.add-a-move-block.step_stepflyFlyingObject": "Haz que el objeto se mueva",
    "gui.howtos.add-a-move-block.step_stepflySelectFlyingSprite": "Selecciona tu personaje",
    "gui.howtos.add-a-move-block.step_stepflyAddScore": "Añadir una puntuación",
    "gui.howtos.add-a-move-block.step_stepflyKeepScore": "Mantener la puntuación",
    "gui.howtos.add-a-move-block.step_stepflyAddScenery": "Añadir escenario",
    "gui.howtos.add-a-move-block.step_stepflyMoveScenery": "Mover el escenario",
    "gui.howtos.add-a-move-block.step_stepflySwitchLooks": "Siguiente disfraz",
    "gui.howtos.pong": "Juego Pong",
    "gui.howtos.pong.step_pongAddBackdrop": "Añadir un fondo",
    "gui.howtos.pong.step_pongAddBallSprite": "Añadir un personaje de pelota",
    "gui.howtos.pong.step_pongBounceAround": "Rebotar alrededor",
    "gui.howtos.pong.step_pongAddPaddle": "Añadir una pala",
    "gui.howtos.pong.step_pongMoveThePaddle": "Mover la pala",
    "gui.howtos.pong.step_pongSelectBallSprite": "Seleccionar el personaje de la pelota",
    "gui.howtos.pong.step_pongAddMoreCodeToBall": "Añadir código para que la pelota rebote en la pala",
    "gui.howtos.pong.step_pongAddAScore": "Añadir una puntuación",
    "gui.howtos.pong.step_pongChooseScoreFromMenu": "Elige 'Puntuación' del menú",
    "gui.howtos.pong.step_pongInsertChangeScoreBlock": "Inserta el bloque 'Cambiar puntuación'",
    "gui.howtos.pong.step_pongResetScore": "Reiniciar puntuación",
    "gui.howtos.pong.step_pongAddLineSprite": "Añadir el personaje de la línea",
    "gui.howtos.pong.step_pongGameOver": "Juego terminado",
    "gui.howtos.code-cartoon": "Codifica un dibujo animado",
    "gui.howtos.code-cartoon.step_codeCartoonSaySomething": "Decir algo cuando haces clic en la bandera verde",
    "gui.howtos.code-cartoon.step_codeCartoonAnimate": "Animar un personaje cuando haces clic en él",
    "gui.howtos.code-cartoon.step_codeCartoonSelectDifferentCharacter": "Seleccionar un personaje diferente",
    "gui.howtos.code-cartoon.step_codeCartoonUseMinusSign": "Usar un signo menos para hacerlo más pequeño",
    "gui.howtos.code-cartoon.step_codeCartoonGrowShrink": "Hacer que un personaje crezca y se encoja",
    "gui.howtos.code-cartoon.step_codeCartoonSelectDifferentCharacter2": "Seleccionar otro personaje diferente",
    "gui.howtos.code-cartoon.step_codeCartoonJump": "Saltar hacia arriba y abajo",
    "gui.howtos.code-cartoon.step_codeCartoonChangeScenes": "Haz clic en un personaje para cambiar de escena",
    "gui.howtos.code-cartoon.step_codeCartoonGlideAround": "Deslizarse alrededor",
    "gui.howtos.code-cartoon.step_codeCartoonChangeCostumes": "Cambiar disfraces",
    "gui.howtos.code-cartoon.step_codeCartoonChooseMoreCharacters": "Elige más personajes para añadir a tu dibujo animado",
    ...
    "gui.howtos.cartoon-network.step_CNglide": "Deslizarse alrededor",
    "gui.howtos.cartoon-network.step_CNpicksprite": "Elige un objeto para perseguir",
    "gui.howtos.cartoon-network.step_CNcollect": "Recolectar objetos",
    "gui.howtos.cartoon-network.step_CNvariable": "Crear una variable de puntuación",
    "gui.howtos.cartoon-network.step_CNscore": "Mantener la puntuación",
    "gui.howtos.cartoon-network.step_CNbackdrop": "Subir de nivel: cambiar fondo",
    "gui.howtos.videosens.name": "Detección de video",
    "gui.howtos.videosens.step_addextension": "Añadir extensión",
    "gui.howtos.videosens.step_pet": "Acariciar al gato",
    "gui.howtos.videosens.step_animate": "Animar",
    "gui.howtos.videosens.step_pop": "Reventar un globo",
    "gui.howtos.say-it-out-loud": "Crear animaciones que hablen",
    "gui.howtos.say-it-out-loud.step_AddTXTextension": "Añadir los bloques de Texto a Voz",
    "gui.howtos.say-it-out-loud.step_TXTSpeech": "Decir algo",
    "gui.howtos.say-it-out-loud_TXTSetVoice": "Configurar una voz",
    "gui.howtos.say-it-out-loud.step_TXTMove": "Moverse alrededor",
    "gui.howtos.say-it-out-loud.step_TXTBackdrop": "Añadir un fondo",
    "gui.howtos.say-it-out-loud.step_TXTAddSprite": "Añadir otro personaje",
    "gui.howtos.say-it-out-loud.step_TXTSong": "Interpretar una canción",
    "gui.howtos.say-it-out-loud.step_TXTColor": "Cambiar color",
    "gui.howtos.say-it-out-loud.step_TXTSpin": "Girar alrededor",
    "gui.howtos.say-it-out-loud.step_TXTGrow": "Crecer y encoger",
    "gui.howtos.talking": "Cuentos hablados",
    "gui.howtos.talking.step_talesAddExtension": "Haz clic para añadir los bloques de Texto a Voz",
    "gui.howtos.talking.step_talesChooseSprite": "Elige un personaje",
    ...
    "gui.howtos.talking.step_talesSwitchBackdrop": "Haz clic en un personaje para ir al siguiente fondo",
    "gui.howtos.talking.step_talesChooseAnotherSprite": "Elige otro personaje",
    "gui.howtos.talking.step_talesMoveAround": "Moverse alrededor",
    "gui.howtos.talking.step_talesChooseAnotherBackdrop": "Elige otro fondo",
    "gui.howtos.talking.step_talesAnimateTalking": "Animar el habla",
    ...
    "gui.howtos.talking.step_talesAskAnswer": "Obtén los bloques de Preguntar y Responder de la categoría de Detección",
    "gui.howtos.add-sprite.name": "Añadir un personaje",
    "gui.howtos.add-sprite.step_addSprite": "Añadir un personaje",
    "gui.howtos.add-a-backdrop.name": "Añadir un fondo",
    "gui.howtos.add-a-backdrop.step_addBackdrop": "Añadir un fondo",
    "gui.howtos.change-size.name": "Cambiar tamaño",
    "gui.howtos.glide-around.name": "Deslizar alrededor",
    "gui.howtos.change-size.step_glideAroundBackAndForth": "Deslizar alrededor",
    "gui.howtos.change-size.step_glideAroundPoint": "Deslizarse a un punto",
    ...
    "gui.howtos.change-size.step_recordASoundPressRecordButton": "Presiona el botón de grabación",
    ...
    "gui.howtos.change-size.step_spinPointInDirection": "Configurar dirección",
    "gui.howtos.hide-and-show.name": "Esconder y mostrar",
    "gui.howtos.change-size.step_hideAndShow": "Esconder y mostrar",
    "gui.howtos.switch-costume.name": "Animar un personaje",
    "gui.howtos.change-size.step_switchCostumes": "Animar un personaje",
    "gui.howtos.move-around-with-arrow-keys.name": "Usar teclas de flecha",
    "gui.howtos.add-a-backdrop.step_moveArrowKeysLeftRight": "Mover a la izquierda y derecha",
    "gui.howtos.add-a-backdrop.step_moveArrowKeysUpDown": "Mover arriba y abajo",
    "gui.howtos.add-effects.name": "Añadir efectos",
    "gui.howtos.videosens.step_addEffects": "Añadir efectos",
    "gui.device.esp32.description": "Placa de control Wi-Fi y Bluetooth con funciones avanzadas.",
    "gui.device.esp32.connectingMessage": "Conectando",
    "gui.device.esp8266NodeMCU.description": "Placa de control Wi-Fi de bajo costo.",
    "gui.device.esp8266NodeMCU.connectingMessage": "Conectando",
    "gui.device.unselectDevice.name": "Deseleccionar dispositivo",
    "gui.device.unselectDevice.description": "Deseleccionar el dispositivo, volver al modo de programación en tiempo real.",
    "gui.device.arduinoUno.description": "Una gran placa para empezar con la electrónica y la programación.",
    "gui.device.arduinoUno.connectingMessage": "Conectando",
    "gui.device.arduinoNano.description": "El Arduino Nano es una placa pequeña clásica para construir tus proyectos.",
    "gui.device.arduinoNano.connectingMessage": "Conectando",
    "gui.device.arduinoLeonardo.description": "La clásica placa Arduino que puede actuar como ratón o teclado.",
    "gui.device.arduinoLeonardo.connectingMessage": "Conectando",
    "gui.device.arduinoMega2560.description": "La placa de 8 bits con 54 pines digitales, 16 entradas analógicas y 4 puertos seriales.",
    "gui.device.arduinoMega2560.connectingMessage": "Conectando",
    "gui.device.microbit.description": "El ordenador de bolsillo que transforma el aprendizaje de habilidades digitales.",
    "gui.device.microbit.connectingMessage": "Conectando",
    "gui.device.microbitV2.description": "Procesador mejorado, altavoz y micrófono integrados, logotipo sensible al tacto.",
    "gui.device.microbitV2.connectingMessage": "Conectando",
    "gui.device.makeymakey.description": "Convierte cualquier cosa en una tecla.",
    "gui.device.makeyMakey.connectingMessage": "Conectando",
    "gui.device.k210MaixDock.description": "Una placa de control basada en el chip K210 RISC-V con funciones básicas y todos los pines IO expuestos.",
    "gui.device.k210MaixDock.connectingMessage": "Conectando",
    "gui.device.k210Maixduino.description": "La placa K210 RISC-V con ESP32 incorporado.",
    "gui.device.k210Maixduino.connectingMessage": "Conectando",
    "gui.device.raspberryPiPicoIconURL.description": "La poderosa y flexible placa microcontroladora.",
    ...
    "gui.extension.pen.name": "Pluma",
    "gui.extension.pen.description": "Dibuja con tus personajes.",
    "gui.extension.videosensing.name": "Detección de video",
    "gui.extension.videosensing.description": "Detecta movimiento con la cámara.",
    ...
    "gui.opcodeLabels.costumenumber": "número del disfraz",
    "gui.opcodeLabels.backdropname": "nombre del fondo",
    "gui.opcodeLabels.backdropnumber": "número del fondo",
    "gui.opcodeLabels.volume": "volumen",
    "gui.opcodeLabels.tempo": "tempo",
    "gui.opcodeLabels.answer": "respuesta",
    "gui.opcodeLabels.loudness": "volumen",
    ...
    "gui.opcodeLabels.timer": "temporizador",
    "gui.projectLoader.loadError": "No se pudo cargar el archivo del proyecto seleccionado.",
    "gui.sharedMessages.backdrop": "fondo{index}",
    "gui.sharedMessages.costume": "disfraz{index}",
    "gui.sharedMessages.sprite": "Personaje{index}",
    "gui.sharedMessages.pop": "pop",
    "gui.sharedMessages.replaceProjectWarning": "¿Reemplazar el contenido del proyecto actual?",
    "gui.sharedMessages.clearCacheWarning": "¿Estás seguro de que deseas limpiar la caché y reiniciar?",
    "gui.sharedMessages.loadFromComputerTitle": "Cargar desde tu computadora",
    "gui.gui.defaultProjectTitle": "Proyecto Digital Codeblock",
    "gui.desktopMenuBar.about": "Acerca de",
    "gui.desktopMenuBar.license": "Licencia",
    "gui.menuBar.privacyPolicy": "Política de privacidad",
    "gui.menuBar.dataSettings": "Configuración de datos",
  ...
  "ru": {
    "gui.alerts.lostPeripheralConnection": "OpenBlock потерял соединение с {extensionName}.",
    ...
    "gui.device.esp32.connectingMessage": "Подключение",
    "gui.device.esp8266NodeMCU.description": "Недорогая плата Wi-Fi  для управления",
    "gui.device.esp8266NodeMCU.connectingMessage": "Подключение",
    ...
    "gui.device.arduinoLeonardo.connectingMessage": "Подключение",
    ...
    "gui.device.k210MaixDock.connectingMessage": "Подключение",
    "gui.device.k210Maixduino.description": "Плата K210 RISC-V с ESP32 внутри.",
    "gui.device.k210Maixduino.connectingMessage": "Подключение",
    "gui.device.raspberryPiPicoIconURL.description": "Мощная, гибкая плата микроконтроллера.",
    "gui.device.raspberryPiPicoIconURL.connectingMessage": "Подключение",
